...
with open("C:\\GRB-JET-ENERGY-MODEL\\config\\GRB3-Configurations\\Parameters-GRB3.yaml", "r") as file: # Put your path to the Parameters.yaml file.
...
# ************************
initialAngle = 0.8 # 0.075 Initial Angle of GRB, in radians. Input degree/radian value for Initial Angle, use the DegreesToRadians function if needed.
...
with open("C:\\GRB-JET-ENERGY-MODEL\\config\\GRB3-Configurations\\CalculatedParameters-GRB3.yaml", "w") as file1:
