...
with open("C:\\GRB-JET-ENERGY-MODEL\\config\\GRB1-Configurations\\Parameters-GRB1.yaml", "r") as file: # Put your path to the Parameters.yaml file.
...
# ************************
initialAngle = 0.05 # 0.075 Initial Angle of GRB, in radians. Input degree/radian value for Initial Angle, use the DegreesToRadians function if needed.
...
with open("C:\GRB-JET-ENERGY-MODEL\config\GRB1-Configurations\CalculatedParameters-GRB1.yaml", "w") as file1:
