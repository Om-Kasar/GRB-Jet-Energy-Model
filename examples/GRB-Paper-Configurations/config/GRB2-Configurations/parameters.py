...
with open("C:\\GRB-JET-ENERGY-MODEL\\config\\GRB2-Configurations\\Parameters-GRB2.yaml", "r") as file: # Put your path to the Parameters.yaml file.
...
with open("C:\\GRB-JET-ENERGY-MODEL\\config\\GRB2-Configurations\\CalculatedParameters-GRB2.yaml", "w") as file1:
